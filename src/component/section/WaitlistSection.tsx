        ...
        <section id={'waitlist'} className={`relative md:py-24 py-20 ${themeState.theme == 'light' ? 'bg-primary-100' : 'bg-dark-400'}`}>
            <div
                ...
                <motion.div
                    ...
                    whileInView={'show'}
                    transition={{ease: 'easeOut', duration: 1, delay: 0.2}}
                    className={'w-full md:w-full lg:w-[70%] md:h-[90px] h-[70px] z-[999] flex justify-between items-center  bg-white  px-1 md:px-3 overflow-hidden rounded-[20px] border gap-3'}>
