        ...
        <section id={'waitlist'} className={`relative md:py-24 py-20 ${themeState.theme == 'light' ? 'bg-primary-100' : 'bg-dark-400'}`}>
            <div
                ...
                <motion.div
                    ...
                    <BaseInput leftIcon={EmailIcon} className={`flex-grow h-full ${themeState.theme == 'light' ? 'text-dark' : 'text-white'} bg-transparent placeholder:text-primary-100 w-10`} placeholder={'Email Address'} />
