...
export const DefaultFooter = () => {
    ...
    return(
        <footer className={'py-12  bg-black-200'}>
            <motion.div
                initial={{ opacity: 0, y: -10 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ease:'easeOut', duration: 1, delay: 0.2}}
                className={'container-responsive flex h-full flex-col items-center gap-4'}>
                <div className={' w-full lg:h-[calc(350px-80px)] h-[calc(350px-100px)] flex lg:flex-row flex-col items-center justify-between'}>
                    <div className={'lg:w-1/2 w-full text-center lg:text-end'}>
                        ...
                        <p className={`font-light md:text-[16px] text-[14px] text-white md:leading-[25px] cursor-pointer  leading-[20px]  ${hoverClassName}`}>info@gramenpetroserve.com;,</p>
                        <p className={`font-light md:text-[16px] text-[14px] text-white md:leading-[25px] cursor-pointer  leading-[20px]`}>Plot 18 Chevron Clinic Road, Off NPA DSC-Expressway,</p>
                        <p className={`font-light md:text-[16px] text-[14px]  text-white md:leading-[25px] cursor-pointer  leading-[20px]  `}> Edjeba, Warri, Delta State.</p>
                        <p className={`font-light md:text-[16px] text-[14px]  text-white md:leading-[25px] cursor-pointer  leading-[20px]  `}>
                ...
                <div className={'border-t border-white w-full flex flex-col lg:flex-row  items-center justify-between h-[100px] lg:h-[89px] py-5'}>
                    ...
                    <div className={'flex flex-col items-end'}>
                        <p className={'text-white '}>Copyright © 2024 •Jeala AI</p>
                        <p className={'text-white'}>Privacy & Legal terms</p>
                    </div>
                </div>
            </motion.div>
        </footer>
