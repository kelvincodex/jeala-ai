...
export const DefaultHeader = ()=>{
    ...
    return (
        <nav className={'border-b sticky top-0 bg-white z-50 w-full transition-all duration-300 ease-in-out h-[80px] md:h-[100px] '}>
            ...
            {/*todo mobile*/}
            <ul className={`lg:hidden text-[20px] py-10 absolute bg-white top-20 gap-5 pl-14 min-w-full ${isClose ? 'left-0' : '-left-[100%]'} transition-left duration-150   w-full flex flex-col items-left`}>
